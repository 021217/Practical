...
void loadTextures() {
	skyboxTextures[0] = loadTexture("background.bmp");
	skyboxTextures[1] = loadTexture("background.bmp");
	skyboxTextures[2] = loadTexture("background.bmp");
	skyboxTextures[3] = loadTexture("background.bmp");
	skyboxTextures[4] = loadTexture("background.bmp");
	skyboxTextures[5] = loadTexture("background.bmp");
}
