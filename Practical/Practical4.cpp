...
//
//void loadAllTexture() {
//	allTextures[0] = loadTexture("Box.bmp");
//	allTextures[1] = loadTexture("chocolate.bmp");
//	allTextures[2] = loadTexture("brick.bmp");
//}
//
//
...
//}
//
//void drawFilledCuboid(float width, float height, float length, float x, float y, float z) {
//
//	glBegin(GL_QUADS);
//
//	// Bottom face
...
//}
//
//void drawFilledPyramid(float size) {
//
//	glBegin(GL_TRIANGLES);
//
//	// Set texture coordinates and vertices for each face of the pyramid
//
//	// Base - Two triangles to form the square base
//	glTexCoord2f(0.0f, 0.0f); glVertex3f(0, 0, size);          // Bottom-left
//	glTexCoord2f(1.0f, 0.0f); glVertex3f(size, 0, size);       // Bottom-right
//	glTexCoord2f(1.0f, 1.0f); glVertex3f(size, 0, 0);          // Top-right
//
//	glTexCoord2f(0.0f, 0.0f); glVertex3f(0, 0, size);          // Bottom-left
//	glTexCoord2f(1.0f, 1.0f); glVertex3f(size, 0, 0);          // Top-right
//	glTexCoord2f(0.0f, 1.0f); glVertex3f(0, 0, 0);             // Top-left
//
//	// Side 1
//	glTexCoord2f(0.5f, 1.0f); glVertex3f(size / 2, size, size / 2); // Apex
//	glTexCoord2f(0.0f, 0.0f); glVertex3f(0, 0, size);          // Base corner 1
//	glTexCoord2f(1.0f, 0.0f); glVertex3f(size, 0, size);       // Base corner 2
//
//	// Side 2
//	glTexCoord2f(0.5f, 1.0f); glVertex3f(size / 2, size, size / 2); // Apex
//	glTexCoord2f(0.0f, 0.0f); glVertex3f(size, 0, size);       // Base corner 2
//	glTexCoord2f(1.0f, 0.0f); glVertex3f(size, 0, 0);          // Base corner 3
//
//	// Side 3
//	glTexCoord2f(0.5f, 1.0f); glVertex3f(size / 2, size, size / 2); // Apex
//	glTexCoord2f(0.0f, 0.0f); glVertex3f(size, 0, 0);          // Base corner 3
//	glTexCoord2f(1.0f, 0.0f); glVertex3f(0, 0, 0);             // Base corner 4
//
//	// Side 4
//	glTexCoord2f(0.5f, 1.0f); glVertex3f(size / 2, size, size / 2); // Apex
//	glTexCoord2f(0.0f, 0.0f); glVertex3f(0, 0, 0);             // Base corner 4
//	glTexCoord2f(1.0f, 0.0f); glVertex3f(0, 0, size);          // Base corner 1
//
//	glEnd();
//
//}
...
//void cuboidExercise() {
//	glEnable(GL_TEXTURE_2D);
//	glBindTexture(GL_TEXTURE_2D, allTextures[currentTextureIndex]);
//	glRotatef(rotationSpeed, X, Y, Z);
//	drawFilledCuboid(0.5, 0.5, 0.5, 0, 0, 0);
//
...
//	GLuint textureArr[1];
//
//	textureArr[0] = loadTexture("white-choco.bmp");
//	glRotatef(rotationSpeed, X, Y, Z);
//	drawFilledPyramid(0.5);
//	drawFilledPyramid(-0.5);
...
//	glPushMatrix();
//	textureArr[0] = loadTexture("chocolate-biscuit.bmp");
//	glPushMatrix();
...
//	glDeleteTextures(1, &textureArr[0]);
//
//	textureArr[1] = loadTexture("white-choco.bmp");
//	glPushMatrix();
...
//
//	textureArr[4] = loadTexture("chocolate.bmp");
//	glPushMatrix();
//	glRotatef(-90, 1, 0, 0);
